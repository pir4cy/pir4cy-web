...
author: 'pir4cy'
coverImage: '/images/writeups/covers/htb/lightweight-cover.png'
---
...
![Nmap](/images/writeups/machines/htb/Lightweight/nmap.png "Nmap")

### Web App Enumeration

![front page](/images/writeups/machines/htb/Lightweight/front.png "Front Page")

#### user.php

![user.php](/images/writeups/machines/htb/Lightweight/userphp.png "User.php")

#### status.php

![status.php](/images/writeups/machines/htb/Lightweight/statusphp.png "Status.php")
...
![tcpdump](/images/writeups/machines/htb/Lightweight/tcpdump.png "TCP Dump")
...
![ldapcheck](/images/writeups/machines/htb/Lightweight/ldapcheck.png "LDAP Found")  
Looking further, we find a possible authentication hash for `ldapuser2`  
![ldapuser2](/images/writeups/machines/htb/Lightweight/ldapuser2.png "LDAP User2")

## User Exposed

Elevating to `ldapuser2` using `su` and the hash as password, we log in easily. Thus, exposing `user.txt`

![User found](/images/writeups/machines/htb/Lightweight/userfound.png "User Found")
...
![Backup.7z Denied](/images/writeups/machines/htb/Lightweight/backupdenied.png "Backup.7z Denied")  
...
![Backup PW Found](/images/writeups/machines/htb/Lightweight/backuppwfound.png "Password Cracked")
...
![status reveal](/images/writeups/machines/htb/Lightweight/statusreveal.png "Status.php Reveal")
...
![SysInfo](/images/writeups/machines/htb/Lightweight/uname.png "uname -a")

![SUID Info](/images/writeups/machines/htb/Lightweight/suid.png "SUID info")
...
![Linux Capabilities](/images/writeups/machines/htb/Lightweight/lincap.png "Linux Capabilities") 
...
![root.txt](/images/writeups/machines/htb/Lightweight/root.png "Root.txt")
...
![Sudoers](/images/writeups/machines/htb/Lightweight/sudoers.png "Sudoers")

Changing the original sudoers file and getting root shell.  

![Rooted](/images/writeups/machines/htb/Lightweight/rooted.png "Rooted")
