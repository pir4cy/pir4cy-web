...
author: 'pir4cy'
coverImage: '/images/writeups/covers/lightweight-cover.png'
---
...
![Nmap](/images/writeups/machines/Lightweight/nmap.png "Nmap")

### Web App Enumeration

![front page](/images/writeups/machines/Lightweight/front.png "Front Page")

#### user.php

![user.php](/images/writeups/machines/Lightweight/userphp.png "User.php")

#### status.php

![status.php](/images/writeups/machines/Lightweight/statusphp.png "Status.php")
...
![ldapcheck](/images/writeups/machines/Lightweight/ldapcheck.png "LDAP Found")  
Looking further, we find a possible authentication hash for `ldapuser2`  
![ldapuser2](/images/writeups/machines/Lightweight/ldapuser2.png "LDAP User2")

## User Exposed

Elevating to `ldapuser2` using `su` and the hash as password, we log in easily. Thus, exposing `user.txt`

![User found](/images/writeups/machines/Lightweight/userfound.png "User Found")
...
![Backup.7z Denied](/images/writeups/machines/Lightweight/backupdenied.png "Backup.7z Denied")  
...
![Backup PW Found](/images/writeups/machines/Lightweight/backuppwfound.png "Password Cracked")
...
![status reveal](/images/writeups/machines/Lightweight/statusreveal.png "Status.php Reveal")
...
![SysInfo](/images/writeups/machines/Lightweight/uname.png "uname -a")

![SUID Info](/images/writeups/machines/Lightweight/suid.png "SUID info")
...
![Linux Capabilities](/images/writeups/machines/Lightweight/lincap.png "Linux Capabilities") 
...
![root.txt](/images/writeups/machines/Lightweight/root.png "Root.txt")
...
![Sudoers](/images/writeups/machines/Lightweight/sudoers.png "Sudoers")

Changing the original sudoers file and getting root shell.  

![Rooted](/images/writeups/machines/Lightweight/rooted.png "Rooted")
