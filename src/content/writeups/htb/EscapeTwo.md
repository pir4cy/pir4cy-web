...
![Nmap Scan](/images/writeups/machines/htb/EscapeTwo/nmap.png "NMAP")
...
![SMB Shares](/images/writeups/machines/htb/EscapeTwo/rose-shares.png)
...
![sa cmdshell](/images/writeups/machines/htb/EscapeTwo/sa-mssql-login.png)
...
```
![sa revshell](/images/writeups/machines/htb/EscapeTwo/sa-revshell-powershell.png)

Successfully obtained a reverse shell as user 'sql_svc'!

![sql_svc shell](/images/writeups/machines/htb/EscapeTwo/sql-svc-shell.png)

## User Access

As 'sql_svc', we find a config file containing credentials:

![sql_svc creds](/images/writeups/machines/htb/EscapeTwo/sql-svc-creds-found.png)
...
![ryan-same-password](/images/writeups/machines/htb/EscapeTwo/ryan-pwned-same-password.png)

Great! We can authenticate as 'ryan' and can grab the user.txt flag.

![ryan-pwned](/images/writeups/machines/htb/EscapeTwo/user-pwned.png)
...
![ryan-writeowner](/images/writeups/machines/htb/EscapeTwo/ryan-permissions-write.png)
...
![ryan-abusing-writeowner](/images/writeups/machines/htb/EscapeTwo/ryan-abusing-writeOwner.png)
...
```
![certipy find](/images/writeups/machines/htb/EscapeTwo/certipy-find-certificates.png)
...
![exploitable template](/images/writeups/machines/htb/EscapeTwo/certipy-dundermifflin-template.png)
...
![certipy admin req](/images/writeups/machines/htb/EscapeTwo/certipy-admin-forge.png)
...
![admin hash](/images/writeups/machines/htb/EscapeTwo/admin-hash.png)
...
![rooted](/images/writeups/machines/htb/EscapeTwo/rooted.png)
...
> **Conclusion:**
> This box demonstrates a realistic attack chain involving credential
discovery, Active Directory permission abuse, and certificate template
exploitation. It showcases important security weaknesses in certificate
templates that are often overlooked.
