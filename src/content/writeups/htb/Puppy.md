...
![Nmap Scan](/images/writeups/machines/htb/Puppy/nmap.png "NMAP")
...
![levi james credentials](/images/writeups/machines/htb/Puppy/levi-valid.png)
...
![levi-smb-shares](/images/writeups/machines/htb/Puppy/levi-smb-shares.png)
...
![nxc-bloodhound](/images/writeups/machines/htb/Puppy/nxc-bloodhound.png)

Either of the methods should provide some collection data that we can then load into Bloodhound.

![bloodhound-ingest](/images/writeups/machines/htb/Puppy/bloodhound-upload-files.png)
## Foothold
...
![bloodhound-levi](/images/writeups/machines/htb/Puppy/bloodhound-levi.png)
...
![bloodhound-write-access](/images/writeups/machines/htb/Puppy/bloodhound-write-access.png)
...
![levi-dev-share](/images/writeups/machines/htb/Puppy/levi-dev-share.png)
...
![KeePass Locked - Big F](/images/writeups/machines/htb/Puppy/kdbx-locked-sadge.png)

I tried using `keepass2john` to bruteforce the password but sadly, John does not support the 4.x format :(
![no john support](/images/writeups/machines/htb/Puppy/keepass2john-fail.png)
...
![keepass4brute-success](/images/writeups/machines/htb/Puppy/keepass4brute-success.png)

Gotta love the weak password for password manager. Using the acquired password, we are able to view the database - 
![keepass-expose](/images/writeups/machines/htb/Puppy/keepass-expose.png)


#### Current Loot
- Usernames - we can grab the entire list of users from bloodhound directly
![bloodhound-users](/images/writeups/machines/htb/Puppy/bloodhound-all-users.png)
- Passwords - including our credentials and the ones we grabbed from the database
![loot-captured-1](/images/writeups/machines/htb/Puppy/loot-foothold.png)

Before we move on, let's test these credentials to see if we get any sort of access.
![ant.edward credential](/images/writeups/machines/htb/Puppy/ant-edwards-valid-cred.png)
...
![bloodhound ant edwards](/images/writeups/machines/htb/Puppy/bloodhound-ant.png)
...
![adam silver owned](/images/writeups/machines/htb/Puppy/adam-silver-owned.png)

Let's update this on bloodhound and see what we can get from Adam's account.
![adam remote access](/images/writeups/machines/htb/Puppy/adam-silver-access.png)

Testing credentials with `nxc winrm` mode.
![nxc winrm](/images/writeups/machines/htb/Puppy/adam-silver-nxc-winrm.png)
...
![user pwn](/images/writeups/machines/htb/Puppy/user-pwned.png)
...
![backup files found](/images/writeups/machines/htb/Puppy/backup-exposed.png)
...
![steph-cooper-pwn](/images/writeups/machines/htb/Puppy/steph-cooper-password.png)

- New credentials: `steph.cooper:ChefSteph2025!`

Testing it out with nxc again - 
![steph cooper owned](/images/writeups/machines/htb/Puppy/steph-cooper-owned.png)
...
![dpapi cred files](/images/writeups/machines/htb/Puppy/dpapi-creds-transfer.png)
...
![dpapi decrypted](/images/writeups/machines/htb/Puppy/dpapi-decrypted-key.png)
...
![steph cooper adm](/images/writeups/machines/htb/Puppy/dpapi-creds-cracked.png)

We can now use these to grab the root flag from `C:\\Users\\Administrator\\Desktop`

### Rooted
![Pwned](/images/writeups/machines/htb/Puppy/puppy-pwnd.png)
