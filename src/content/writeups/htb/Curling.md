...
author: 'pir4cy'
coverImage: '/images/writeups/covers/htb/curling-cover.png'
os: 'linux'
difficulty: 'easy'
logos:
...
![Nmap](/images/writeups/machines/htb/Curling/nmap.png "Nmap")

### Website

![Website](/images/writeups/machines/htb/Curling/website.png "Website Main Page")

#### Source Code

Looking at the source code of the main page, we find `<!-- secret.txt -->`
![Source Code](/images/writeups/machines/htb/Curling/sourceCode.png "Source Code")
...
![LoggedIn](/images/writeups/machines/htb/Curling/loggedIn.png "Logged In Main Page")

#### /administrator/ - Joomla Interface

Trying the same credentials for Joomla interface
![Joomla Interface](/images/writeups/machines/htb/Curling/joomlaInterface.png "Joomla Interface")

And we are in: 

![Joomla Accessed](/images/writeups/machines/htb/Curling/joomlaAccess.png "Logged In Joomla")
...
Step 1: Go to Extensions -> Templates
    ![Templates](/images/writeups/machines/htb/Curling/template1.png "Templates")
Step 2: Go to Templates -> Options
    ![Templates->Options](/images/writeups/machines/htb/Curling/template2.png "Templates -> Options")
Step 3: Set Public and Super User permissions to be allowed
    ![Permissions](/images/writeups/machines/htb/Curling/permissions.png "Permissions")
    Save and close.  
Step 4: Click on Templates and open Beez3 Details
    ![Templates->Templates](/images/writeups/machines/htb/Curling/templateBeez3.png "Templates Details")
    Edit `index.php`    
    ![Beez3 Details](/images/writeups/machines/htb/Curling/beez3.png "Beez3 Details")
...
![Shell Obtained](/images/writeups/machines/htb/Curling/shellObtained.png "Shell Obtained")
...
![WWW-Data](/images/writeups/machines/htb/Curling/wwwData.png "wwwdata")
...
![Base64 Conversion](/images/writeups/machines/htb/Curling/base64Conv.png "Base 64 Conversion")

![Base64 Decode](/images/writeups/machines/htb/Curling/base64Dec.png "Base 64 Decode")
...
![Less Output](/images/writeups/machines/htb/Curling/lessOutput.png "Less Password_Backup")
...
![password_backup](/images/writeups/machines/htb/Curling/passwordBackup.png "Cracking password_backup")

We can directly try this password using `su --floris`, but it didn't work

![su fail](/images/writeups/machines/htb/Curling/suFail.png "su fail")
...
![SSH](/images/writeups/machines/htb/Curling/sshLogin.png "SSH Logged In")

And we get `user.txt`

![User Exposed](/images/writeups/machines/htb/Curling/userExposed.png "User Exposed")
...
Opening them up, we can see the contents of both files:
  ...
  * input
    ![input file](/images/writeups/machines/htb/Curling/inputFile.png "Input File")
  * report
    ![input file](/images/writeups/machines/htb/Curling/reportFile.png "Input File")
...
#### PSPY OUTPUT
![PSPY Output](/images/writeups/machines/htb/Curling/pspyOutput.png "PSPY Output")
...
![Way One of getting root](/images/writeups/machines/htb/Curling/root1.png "Way One of getting root")
...
Step 3: Edit the input file, like so  
    ![input File root](/images/writeups/machines/htb/Curling/inputRoot2.png "Input File for Way 2")
Step 4: Wait for the cronjob to execute, which will download `sudoers.txt` to `/etc/sudoers`
    ![sudoers updated](/images/writeups/machines/htb/Curling/sudoers.png "Sudoers Updated")
Step 5: Run `sudo su`
    ![Root Gained](/images/writeups/machines/htb/Curling/root2.png "Way 2 of getting root")
