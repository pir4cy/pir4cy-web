...
author: 'pir4cy'
coverImage: '/images/writeups/covers/curling-cover.png'
os: 'linux'
difficulty: 'easy'
logos:
...
![Nmap](/images/writeups/machines/Curling/nmap.png "Nmap")

### Website

![Website](/images/writeups/machines/Curling/website.png "Website Main Page")

#### Source Code

Looking at the source code of the main page, we find `<!-- secret.txt -->`
![Source Code](/images/writeups/machines/Curling/sourceCode.png "Source Code")
...
![LoggedIn](/images/writeups/machines/Curling/loggedIn.png "Logged In Main Page")

#### /administrator/ - Joomla Interface

Trying the same credentials for Joomla interface
![Joomla Interface](/images/writeups/machines/Curling/joomlaInterface.png "Joomla Interface")

And we are in: 

![Joomla Accessed](/images/writeups/machines/Curling/joomlaAccess.png "Logged In Joomla")
...
Step 1: Go to Extensions -> Templates
    ![Templates](/images/writeups/machines/Curling/template1.png "Templates")
Step 2: Go to Templates -> Options
    ![Templates->Options](/images/writeups/machines/Curling/template2.png "Templates -> Options")
Step 3: Set Public and Super User permissions to be allowed
    ![Permissions](/images/writeups/machines/Curling/permissions.png "Permissions")
    Save and close.  
Step 4: Click on Templates and open Beez3 Details
    ![Templates->Templates](/images/writeups/machines/Curling/templateBeez3.png "Templates Details")
    Edit `index.php`    
    ![Beez3 Details](/images/writeups/machines/Curling/beez3.png "Beez3 Details")
...
![Shell Obtained](/images/writeups/machines/Curling/shellObtained.png "Shell Obtained")
...
![WWW-Data](/images/writeups/machines/Curling/wwwData.png "wwwdata")
...
![Base64 Conversion](/images/writeups/machines/Curling/base64Conv.png "Base 64 Conversion")

![Base64 Decode](/images/writeups/machines/Curling/base64Dec.png "Base 64 Decode")
...
![Less Output](/images/writeups/machines/Curling/lessOutput.png "Less Password_Backup")
...
![password_backup](/images/writeups/machines/Curling/passwordBackup.png "Cracking password_backup")

We can directly try this password using `su --floris`, but it didn't work

![su fail](/images/writeups/machines/Curling/suFail.png "su fail")
...
![SSH](/images/writeups/machines/Curling/sshLogin.png "SSH Logged In")

And we get `user.txt`

![User Exposed](/images/writeups/machines/Curling/userExposed.png "User Exposed")
...
#### PSPY OUTPUT
![PSPY Output](/images/writeups/machines/Curling/pspyOutput.png "PSPY Output")
...
![Way One of getting root](/images/writeups/machines/Curling/root1.png "Way One of getting root")
...
Step 3: Edit the input file, like so  
    ![input File root](/images/writeups/machines/Curling/inputRoot2.png "Input File for Way 2")
Step 4: Wait for the cronjob to execute, which will download `sudoers.txt` to `/etc/sudoers`
    ![sudoers updated](/images/writeups/machines/Curling/sudoers.png "Sudoers Updated")
Step 5: Run `sudo su`
    ![Root Gained](/images/writeups/machines/Curling/root2.png "Way 2 of getting root")
