...
![Source Code](/images/writeups/machines/Teacher/sourcecode.png "Doubt")

Checking the console we find what we expected  
![F](/images/writeups/machines/Teacher/f.png "That's an F")
...
![Copied](/images/writeups/machines/Teacher/websitecopied.png "Copied website")

The above output in console tells me that there's something peculiar about `5.png`, let's check it out  
![strings 5](/images/writeups/machines/Teacher/strings5.png "Strings")

#### Moodle

![Moodle](/images/writeups/machines/Teacher/moodle.png "Moodle")
...
Step 2: Add a calculated question.
	![Adding a Question](/images/writeups/machines/Teacher/questionadd.png "Calculated Question")  
Step 3: Add the formula given to the answer.
	![Answer](/images/writeups/machines/Teacher/formulaUsed.png "Formula Used")  
...
![RevShell](/images/writeups/machines/Teacher/revshell.png "RevShell")

## User Elevation

Using `ps aux` we find that we have a MySQL service running in the system.  
![Ps Aux](/images/writeups/machines/Teacher/psaux.png "ps aux")

Enumerating the current directory  
![Enumeration](/images/writeups/machines/Teacher/accessibledata.png "LS")

Let's checkout `config.php`  
![Config.php](/images/writeups/machines/Teacher/configphp.png "Config.php")
...
![MariaDB login](/images/writeups/machines/Teacher/mariadblogin.png "Logged In")

Checking the databases we can operate with using `show databases;`  
![Databases](/images/writeups/machines/Teacher/databases.png "Databases")
...
![unorganised output](/images/writeups/machines/Teacher/selectstar.png "Unreadable")

Let's try to make it readable using `select id,auth,username,password from mdl_user;`  
![Password](/images/writeups/machines/Teacher/passdiscovers.png "Password")
...
![su](/images/writeups/machines/Teacher/tryingSU.png "su")

## User Gained

![User](/images/writeups/machines/Teacher/usergained.png "User")
...
![Exploiting Backup](/images/writeups/machines/Teacher/root.png "Root.txt Gained")
