...
![HackSmarter Nmap](/images/writeups/machines/hacksmarter/HSM_Casino/nmap.png "Nmap")
...
![Web Portal](/images/writeups/machines/hacksmarter/HSM_Casino/web-portal-1.png "Web Portal")
...
![Burp 1](/images/writeups/machines/hacksmarter/HSM_Casino/burp-1.png "Burp 1")

Forward to Repeater (ctrl+r) and let's see what we get from this JS file:  

![Burp 2](/images/writeups/machines/hacksmarter/HSM_Casino/burp-2.png "Burp 2")

Another one to explore further:  

![Burp 3](/images/writeups/machines/hacksmarter/HSM_Casino/burp-3.png "Burp 3")
...
![Burp 4](/images/writeups/machines/hacksmarter/HSM_Casino/burp-4.png "Burp 4")
...
![Burp 5](/images/writeups/machines/hacksmarter/HSM_Casino/burp-5.png "Burp 5")
...
![FFUF](/images/writeups/machines/hacksmarter/HSM_Casino/ffuf-1.png "FFUF")
...
![Dashboard](/images/writeups/machines/hacksmarter/HSM_Casino/dashboard-1.png "Dashboard")
...
![Profile 1](/images/writeups/machines/hacksmarter/HSM_Casino/profile-1.png "Profile 1")

Looks like we can make changes to the display name here.

![Profile 2](/images/writeups/machines/hacksmarter/HSM_Casino/profile-2.png "Profile 2")
...
![SSTI 1](/images/writeups/machines/hacksmarter/HSM_Casino/ssti-1.png "SSTI 1")
...
![SSTI 2](/images/writeups/machines/hacksmarter/HSM_Casino/ssti-2.png "SSTI 2")
...
![SSTI 3](/images/writeups/machines/hacksmarter/HSM_Casino/ssti-3.png "SSTI 3")

Before hitting save, make sure to have a listener ready. I"m using penelope to get a stable shell.  

![Shell 1](/images/writeups/machines/hacksmarter/HSM_Casino/shell-1.png "Shell 1")

## Post Exploitation

As `www-data`, we are able to read the home directories of users `david` & `george` :  

![Shell 2](/images/writeups/machines/hacksmarter/HSM_Casino/shell-2.png "Shell 2")
...
![Penelope](/images/writeups/machines/hacksmarter/HSM_Casino/penelope-1.png "Penelope")

Now let's try to connect to the box as george.  

![Shell as George](/images/writeups/machines/hacksmarter/HSM_Casino/shell2-george.png "Shell as George")

Port 22 didn't work but port 2222 worked :D

Looking around, we see some interesting strings in `george`'s bash_history:  

![George Bash History](/images/writeups/machines/hacksmarter/HSM_Casino/george-bash-history.png "George Bash History")

### User - david

With the password in hand, we can now login as david:  

![Login as David](/images/writeups/machines/hacksmarter/HSM_Casino/login-as-david.png "Login as David")
...
![Rooted](/images/writeups/machines/hacksmarter/HSM_Casino/casino-rooted.png "Rooted")
